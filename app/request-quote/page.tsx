...
const [values, setValues] = useState<Record<string, string>>({});
  ...
  return (
    ...
    <form 
    ref={formRef}
    className={clsx("pt-32 w-screen", validated && "validated")}
    noValidate
    ...
    <Dropdown id={"deliverable"} label={"What is the expected deliverable?"} name={"deliverable"} options={["Proofread copy", "Structural edit", "Polished final version", "Tracked-changes file", "Annotated comments", "Not sure", "Other, please describe below"]} showError={isInvalid("deliverable")} onChange={(e) => handleFieldChange("deliverable", e.target.value)}/>
        <div className="col-span-2">
          ...
          <Button id="submit-button" type="submit" href="#" content="Submit" extraClassName={clsx("col-span-1 mt-8 rounded-md bg-[#c58210] px-3.5 py-2.5 text-center text-sm/6 font-semibold text-white hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600")} />
    </div>
    </form>
    </div>
  );
