  ...
  return (
    <div className="pt-32 lg:max-w-320 max-w-64 md:max-w-180 mx-auto mt-10 text-center mb-25">
      <div>
        ...
        <p className="md:col-span-3 md:text-left md:mt-10 text-md text-error bg-error">
